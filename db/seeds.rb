...
Job.create!(company_id: company_four.id, title: "Laborer", job_type: "Entry Level - Salary", job_status: "Temporary", job_description: "Hard work and get paid less", hours_per_week: 60, pay_min: 15.0, pay_max: nil, pay_comment: "minimal wage", applicant_experience: "none", how_to_apply: "In person", job_location: "333 Third St", job_local_remote: "Local", approved:true)
