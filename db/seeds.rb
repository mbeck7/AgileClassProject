...
Job.create!(company_id: company_two.id, title: "Sales", job_type: "Entry Level - Salary", job_status: "Intership", job_description: "Selling Electronics and dealing with Customers", hours_per_week: 40, pay_min: 30.0, pay_max: nil, pay_comment: "Will discuss", applicant_experience: "none", how_to_apply: "In person", job_location: "111 First St", approved:true)
